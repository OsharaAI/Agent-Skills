...
Copy-paste material referenced from `SKILL.md`: a Definition of Done built around quality gates, and a worksheet for self-assessing maturity. The explanation of how to enforce the DoD and how to read the maturity levels stays in `SKILL.md`.
