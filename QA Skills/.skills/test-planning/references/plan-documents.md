...
Ready-to-copy documents covering sprint plans, release plans, coverage matrices, and estimation worksheets. For guidance on which one to use and when, see `SKILL.md` — this file just holds the templates themselves, verbatim.
...
This rolls up the sprint plans underneath a release and layers on the concerns that only apply at release time.
