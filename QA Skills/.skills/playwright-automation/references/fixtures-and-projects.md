# Working With Fixtures and Projects

Fixtures give Playwright a way to handle setup, teardown, and dependency injection all in one mechanism. They stand in for `beforeEach`/`afterEach` hooks with pieces that compose, carry type information, and clean up on their own.

---

## Scoping a Fixture: Per Test or Per Worker
