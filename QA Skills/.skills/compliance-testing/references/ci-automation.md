...
Run the compliance suite weekly so configuration drift gets caught as it happens, not only at PR time. Compliance evidence is kept around longer than ordinary test artifacts, to support audit-trail requirements.
