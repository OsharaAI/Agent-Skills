...
Fill-in scaffolds matching each workflow step described in `SKILL.md`. That file carries the reasoning for when and why to use each one; this one just holds the blank artifacts themselves.
