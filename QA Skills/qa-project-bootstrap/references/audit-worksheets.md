...
These are the fill-in-the-blank worksheets for auditing test suite health. `SKILL.md` holds the guidance on what to assess and how to categorize the output — this file is just the blank templates, to be copied and completed during the 2–4 hour audit.
