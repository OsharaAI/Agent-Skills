...
Every project should have a document like this one — it's the main reference anyone writing tests will turn to. The rationale and decision-making prose lives over in `SKILL.md`; what's here is the complete set of templates and code blocks meant to be copied and adapted directly.
...
Capture patterns specific to the project. For example:
