...
Working code for the scenarios that only exist on mobile: deep links, push notifications, network simulation, permission dialogs, and app lifecycle. The rationale for treating these as first-class flows lives in `SKILL.md`.
