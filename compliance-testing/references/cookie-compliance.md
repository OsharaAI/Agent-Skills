...
A typed cookie inventory serves as the source of truth; the tests confirm actual cookies match it. The reasoning and guidance live in `SKILL.md`; this file holds the implementations.
...
Catch new cookies showing up that aren't part of the inventory:
