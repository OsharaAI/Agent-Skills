...
Runnable Playwright patterns for Coalition for Better Ads compliance. The table of unacceptable formats and the test approaches live in `SKILL.md`; this file holds the implementations.

> The CBA added two desktop and two mobile ad experiences on 14 Jan 2025; Chrome's ad-filtering assessment for those won't start any earlier than **14 May 2026**. If your site uses these newer combined formats, re-check them against the current Better Ads Standards page before that date.
